...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:13px;">
  <tr>
    <td><div id="captchaimage"><a href="" id="refreshimg" onClick="refreshimg(); return false;" title="Click to refresh image"><img src="captcha/image.php<?php echo time() ?>" alt="Captcha image" width="132" height="46" align="left" /></a></div></td>
    <td></td>
  </tr>
</table>
